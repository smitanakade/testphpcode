...
function parseMenu(json, id)
{
    ...
    for (var idx = 0; idx < jsonObj.length; idx++)
    {
        ...
        {
        	html += '<a href="#" class="menu-container"><div class="btn-menu2">' + jsonObj[idx] ["CategorieDescription"] + '</div><div class="menu-child">';
          for (var idxSub = 0; idxSub < jsonObj[idx].sub.length; idxSub++)
          {
          console.log(jsonObj[idx].sub[idxSub]);

           html += '<a href="/content/bra-fitting-etiquette/index.html" class="lnkmenu"><div class="btn-menu2">' + jsonObj[idx].sub[idxSub] ["subDescription"] + '</div></a>';
          }
          html += '</div></a>'
        }
        else
        {
        html += '<a href="/content/bra-fitting-etiquette/index.html" class="lnkmenu"><div class="btn-menu2">' + jsonObj[idx] ["CategorieDescription"] + '</div></a>';
        }
    }
    return html;
